function correlationPlot(numOfTicks, chart_type, series_names) {
    ...
    var 
        ...
        yAxis = d3.svg.axis().scale(y).orient("left").tickSize(6, 0).tickValues([0, 25, 50, 75,100]).tickFormat(d3.format("g")),
